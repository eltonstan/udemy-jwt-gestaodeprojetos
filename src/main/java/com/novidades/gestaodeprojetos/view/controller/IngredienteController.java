...
public class IngredienteController {
	...
	@GetMapping("/{id}")
	public Optional<Ingrediente> obterPorId(@PathVariable("id") Long id) {
		return ingredienteService.obterPorId(id);
	}

	@PostMapping
	public Ingrediente adicionar(@RequestBody Ingrediente categoria) {
		return ingredienteService.adicionar(categoria);
	}
	
	@PutMapping("/{id}")
	public Ingrediente atualizar(@PathVariable("id") Long id, @RequestBody Ingrediente ingrediente) {
